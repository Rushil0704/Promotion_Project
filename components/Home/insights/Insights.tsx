    ...
    return (
        <div className="container py-12 md:py-16">
            ...
            <div className="flex justify-between items-center mb-12">
                ...
                <button className="bg-teal-900 hover:bg-teal-800 text-yellow-400 font-semibold py-2 px-6 rounded-full transition-colors duration-300">
                    View all
                </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {insightCards.map((card) => (
                    <div key={card.id} className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
                        {/* Card Image */}
