    ...
    return (
		<div className="container relative pt-10">
			<div className="bg-yellow-400 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 ">
				...
				<div className="flex-1 text-left md:max-w-[60%]">
					...
					<p className="text-gray-700 text-lg mb-8 leading-relaxed">
						Your health starts with awareness. Use our smart scanner
						to decode labels, spot hidden ingredients, and choose
						food that truly supports your lifestyle.
					</p>

					<button className="bg-[#114D3A]  text-primary font-semibold py-3 px-8 rounded-full transition-colors duration-300">
						Try The Scanner Now
					</button>
				</div>
			</div>
			<Image
				...
				height={300}
				width={500}
				className="object-contain absolute w-auto h-80 md:h-130 bottom-0 right-20 md:block hidden"
				priority
			/>
		</div>
	);
